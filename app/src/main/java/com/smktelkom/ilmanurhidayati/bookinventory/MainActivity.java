...
import com.smktelkom.ilmanurhidayati.bookinventory.activity.BookFormActivity;
import com.smktelkom.ilmanurhidayati.bookinventory.adapter.BooksAdapter;
import com.smktelkom.ilmanurhidayati.bookinventory.adapter.DividerDecoration;
import com.smktelkom.ilmanurhidayati.bookinventory.helper.HelperFunction;
...
public class MainActivity extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    private void prepareBookData() {
        Book book = new Book("9780439064873", "Harry Potter And The Chamber Of Secrets", "J.K. Rowling", 2000, "Fantasy, Thriller, Mystery", "Sinopsis Harry Potter", R.drawable.hp_chamber);
        bookList.add(book);

        book = new Book("9780316015844", "Twilight (The Twilight Saga, Book 1)", "Stephanie Meyer", 2006, "Fantasy, Drama, Romance", "Sinopsis Twilight", R.drawable.twilight1);
        bookList.add(book);

        book = new Book("9781484724989", "Journey to Star Wars: The Force Awakens Lost Stars", "Claudia Gray", 2015, "Action, Thriller, Science Fiction", "Sinopsis Star Wars", R.drawable.star_wars);
        bookList.add(book);

        book = new Book("9780439136365", "Harry Potter and the Prisoner of Azkaban", "J.K. Rowling", 2001, "Fantasy, Thriller, Mystery", "Sinopsis Star Wars", R.drawable.hp_azkaban);
        bookList.add(book);

package com.smktelkom.ilmanurhidayati.bookinventory.model;

import java.io.Serializable;

/**
 * Created by Ilma Nur Hidayati on 11/04/2017.
 */
public class Book implements Serializable {
    ...
    //constructor
    public Book(String pISBN, String book_title,
                String pBookAuthor, int pPublishedYear, String book_genre, String synopsis, int cover) {
        ISBN = pISBN;
